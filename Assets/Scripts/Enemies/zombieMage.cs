...
public class zombieMage : MonoBehaviour
{
    ...
    private void createProjectile(){
        ...
        projectileMovement();
        projectileDirection = (Player.instance.transform.position + Vector3.up * 1.5f - createdProjectile.transform.position).normalized * 7.5f;
    }

    private void projectileMovement(){
        createdProjectile.transform.position += projectileDirection * Time.deltaTime;
        createdProjectile.transform.Rotate(new Vector3(0, 90, 0) * Time.deltaTime);
